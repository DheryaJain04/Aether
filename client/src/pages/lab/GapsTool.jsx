    ...
    return (
        <div className='lab-tool-shell'>
            <div className='lab-tool-header'>
                ...
                <p className='lab-tool-desc'>Aether reads across your selected papers to surface unexplored areas — identifying what has not been studied, methodological blind spots, and open questions the field has yet to answer.</p>
            </div>
            ...
            {!hasPapers ? (
                ...
                <>
                    ...
                    <div className='lab-tool-output-placeholder'>
                        ...
                        <div className='lab-tool-output-placeholder-text'>The Gap Detector will identify unexplored research areas, open questions, and methodological blind spots across your selected papers. Add papers to the bench to get started.</div>
                    </div>
                </>
            )}
        </div>
